...
Future createGrade(
  ...
  Set<String> gradeTypeSelection = {'T'};
                      ...
                      backgroundColor: WidgetStateProperty.resolveWith((
                        ...
                        if (states.contains(WidgetState.selected)) {
                          ...
                          if (gradeTypeSelection.contains("T")) {
                            return Colors.redAccent; // Set color for "T"
                          } else if (gradeTypeSelection.contains("K")) {
                            return Colors.greenAccent; // Set color for "K"
                          } else if (gradeTypeSelection.contains("A")) {
                            return Colors.blueAccent; // Set color for "A"
                          } else if (gradeTypeSelection.contains("P")) {
                            return Colors.lightBlueAccent; // Set color for "P"
                          } else if (gradeTypeSelection.contains("I")) {
                            return Colors.deepPurpleAccent; // Set color for "I"
                          }
                        }
