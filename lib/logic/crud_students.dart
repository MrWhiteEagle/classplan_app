    ...
    builder:
        (context) => AlertDialog(
          ...
          actions: [
            ...
            MaterialButton(
              onPressed: () {
                context.read<StudentDatabase>().addStudent(
                  nameController.text,
...
void fetchStudentDetails(BuildContext context, int studentId) {
  context.read<StudentDatabase>().fetchStudentDetails(studentId);
}
