...
Event _eventDeserialize(
  ...
  object.id = id;
  object.reminder = reader.readDateTime(offsets[2]);
...
extension EventQueryFilter on QueryBuilder<Event, Event, QFilterCondition> {
  ...
  QueryBuilder<Event, Event, QAfterFilterCondition> reminderEqualTo(
      DateTime value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'reminder',
  ...
  QueryBuilder<Event, Event, QAfterFilterCondition> reminderGreaterThan(
    DateTime value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Event, Event, QAfterFilterCondition> reminderLessThan(
    DateTime value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Event, Event, QAfterFilterCondition> reminderBetween(
    DateTime lower,
    DateTime upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension EventQuerySortBy on QueryBuilder<Event, Event, QSortBy> {
  ...
  QueryBuilder<Event, Event, QAfterSortBy> sortByReminder() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'reminder', Sort.asc);
    });
  }

  QueryBuilder<Event, Event, QAfterSortBy> sortByReminderDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension EventQuerySortThenBy on QueryBuilder<Event, Event, QSortThenBy> {
  ...
  QueryBuilder<Event, Event, QAfterSortBy> thenByReminder() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'reminder', Sort.asc);
    });
  }

  QueryBuilder<Event, Event, QAfterSortBy> thenByReminderDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'reminder', Sort.desc);
    });
  }
...
extension EventQueryWhereDistinct on QueryBuilder<Event, Event, QDistinct> {
  ...
  QueryBuilder<Event, Event, QDistinct> distinctByReminder() {
    return QueryBuilder.apply(this, (query) {
...
extension EventQueryProperty on QueryBuilder<Event, Event, QQueryProperty> {
  ...
  QueryBuilder<Event, DateTime, QQueryOperations> reminderProperty() {
    return QueryBuilder.apply(this, (query) {
